      ...
      <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-sm max-h-[80vh] flex flex-col overflow-hidden">
          ...
          <div className="bg-[#FFCCE1] flex items-center justify-center relative px-4 py-3 rounded-t-lg">
            ...
            <button
              onClick={onClose}
              className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray hover:text-gray-800"
              aria-label="닫기"
            >
          ...
          <div className="px-4 py-3 overflow-y-auto">
            ...
            {!isLoading && !error && policy && (
              <>
                {/* 정책 요약 */}
                <p className="text-sm font-bold text-gray-800 mt-2 mb-2 border-b-2 border-pink-300 pb-1">
                  ✅ 한 눈에 보는 정책 요약
                </p>
