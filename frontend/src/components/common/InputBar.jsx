// src/components/common/InputBar.jsx
...
function InputBar({ onSend }) {
  ...
  return (
    <form
      ...
      className="fixed bottom-0 left-0 w-full flex items-center gap-2 bg-white border-t border-gray-200 px-4 py-3 z-[50] h-[70px]"
    >
